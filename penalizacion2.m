% penalizacion2 - Constrained Optimization using Penalty Function Approach (Variant 2)
%
% This function implements a constrained optimization technique using the penalty function approach.
% This variant takes an additional initial point 'x1' for optimization.
% Given an objective function, lower and upper bounds, an initial point, a tolerance level,
% a penalty parameter, and a set of constraint functions, this function aims to find an optimal
...
function [x, fx] = penalizacion2(f, l, u, x1, e, lambda, rest)
    [x, fx] = coordenadas_ciclicas(f, l, u, x1, e, lambda);  % Initialize x and fx using coordenadas_ciclicas function
    ...
    while i < 5
        ...
        [xh, fxh] = coordenadas_ciclicas(fh, l, u, x1, e, lambda);  % Optimize the modified function
